...
float t = 222;
#include "DHT.h"
#define DHTPIN 2     // GPIO 0 on ESP12E Lolin is labelled pin D3 
...
void setup() 
{
 ...
 if (isnan(t) || isnan(h)) {
  ...
  const char APIKey[ ]      = "***************";      //Your maker key for Webhooks on IFTTT-----------
...
// Build URL
  String url = String("/trigger/") + trigger + String("/with/key/") + APIKey + String("?value1=") + String("Humidity=") + h + String("Temperature=") + t;
...
// Send information to thingspeak for records
...
delay(10000);
  ESP.deepSleep(604800e6); //30 for 30 seconds 7200 for 2 hours 86400 for 1 day 604800 for 7 days
 }
